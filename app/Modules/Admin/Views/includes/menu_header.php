                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <span class="d-none d-md-inline"> <?= session()->get('adminData') ? session()->get('adminData')['name'] : "" ?></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-header text-bg-primary">
                                ...
                                <p>
                                <?= session()->get('adminData') ? session()->get('adminData')['name'] : "" ?>
                                                                    <small></small>
                                </p>
                            </li>
                            <!--end::User Image-->
                          ...
                          <!--  </li> -->
                            ...
                            <li class="user-footer">
                                <a href="<?= base_url('admin/user-profile') ?>" class="btn btn-default btn-flat"><?= $profile_arr['label'] ?></a>
                                <a href="<?= base_url('admin/logout') ?>" class="btn btn-default btn-flat float-end"><?= $logout_arr['label'] ?></a>
                            </li>
                            <!--end::Menu Footer-->
                        </ul>
                    </li>
                ...
                <nav class="mt-2">
                    ...
                    <?php if (session()->get('adminData')) {
                        ...
                        <li class="nav-item ">
                            ...
                            <span class="icon14 <?= $parent_arr[$key]['icon'] ?>"></span> 
                                <p>
                                <?= $parent_arr[$key]['label'] ?><i class="nav-arrow bi bi-chevron-right"></i>
                                </p>
                            ...
                            <?php foreach ($child_arr as $k => $v) { ?>
                                ...
                                <li class="nav-item">
                                    <a href="<?= $child_arr[$k]['url'] ?>" class="nav-link <?= $child_arr[$k]['class'] ?>" title="<?= $child_arr[$k]['label'] ?>" target="<?= $child_arr[$k]['target'] ?>"> 
                                    <span class="icon12 <?= $child_arr[$k]['icon'] ?>"></span>
                                    <p> <?= $child_arr[$k]['label'] ?></p>
                                    </a>
                                </li>
                                <?php } ?>
